        ...
        <div className="flex items-center justify-around max-w-md mx-auto relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-9 z-50 pointer-events-none">
            ...
            <button
              ...
              className={`absolute left-1/2 bottom-0 -translate-x-1/2 flex flex-col items-center justify-center gap-1 transition-all duration-300 cursor-pointer border-none bg-transparent ${isBeeMenuOpen
            ...
            <button
              ...
              className={`absolute left-1/2 bottom-0 -translate-x-1/2 flex flex-col items-center justify-center gap-1.5 transition-all duration-300 cursor-pointer border-none bg-transparent ${isBeeMenuOpen
            ...
            return (
              ...
              >
                <div className="relative flex items-center justify-center">
                  <Icon
                    className={`w-5 h-5 transition-transform duration-200 ${isActive ? "stroke-[2.5px] text-[#0A1128]" : "stroke-[1.8px] text-slate-400"
                      }`}
                  />
                  {item.badge ? (
                ...
                <span
                  className={`text-[10px] mt-1 tracking-tight leading-none ${isActive ? "text-[#0A1128] font-black" : "text-slate-500 font-semibold"
                    }`}
                >
                  {item.label}
                </span>
